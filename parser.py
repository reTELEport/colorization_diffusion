...
parser.add_argument('--train_filename', default='./flist/train.flist', type=str,
                    help='The output filename.')
parser.add_argument('--validation_filename', default='./flist/test.flist', type=str,
                    help='The output filename.')
...
if __name__ == "__main__":
    ...
    print(f'train_filename{args.train_filename}')
    print(f'validation_filename{args.validation_filename}')
    ...
    for dir_item in dirs:
        ...
        for training_item in training_folder:
            ...
            training_item = training_item[:-4]
            training_file_names.append(training_item)

        validation_folder = os.listdir(dir_item + "/test")
        for validation_item in validation_folder:
            # validation_item = dir_item + "/test" + "/" + validation_item
            validation_item = validation_item[:-4]
